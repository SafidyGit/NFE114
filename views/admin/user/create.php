...
<?php if (isset($_GET['success'])): ?>
  <div class="alert alert-success alert-dismissible fade show bg-success text-white border-0 shadow" role="alert" style="max-width: 600px;">
    <strong>Succès !</strong> Utilisateur ajouté avec succès !
  ...
  <form method="POST" action="index.php?action=user_store">
    ...
    <div class="row">
      ...
      <div class="col-md-6 mb-3">
        ...
        <input type="email" class="form-control bg-secondary text-white border-0 shadow-none" name="user_email" required>
      </div>
